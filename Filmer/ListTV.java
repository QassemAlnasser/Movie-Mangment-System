...
public class ListTV extends JFrame {
   ...
   public ListTV () {
       ...
       Add.addActionListener(new ActionListener() {
           ...
           if(ListTable.getSelectedRow()!=-1) {
            String ListName = (String)ListTable.getValueAt(ListTable.getSelectedRow(), 0);
               boolean f = r.IsThereTVInList(UserName, ListName, TV_Name);
            if(f)  JOptionPane.showMessageDialog(ListTV.this, "TV-series is already exist in this list ","Error",JOptionPane.ERROR_MESSAGE);  ;
            if(!f) { r.AddTVToList(TV_Name, ListName, UserName);     setVisible(false); inField.setText("");        }           
           } }
       });
        ...
        if("  ".equals(ListName)||"".equals(ListName)||" ".equals(ListName)) {} 
         ...
         String  status= r.AddList(UserName, ListName);
            if("Error".equals(status)) JOptionPane.showMessageDialog(ListTV.this, "List is already exist ","Error",JOptionPane.ERROR_MESSAGE);
            else {
    ...
    public void CreateFrame(String UserName,String TV_Name) {
